...
OUTPUT_FILE_NAME = "mdim_Torrelles_de_Llobregat_sen.nc"
...
FILTER_MUNICIPALITY = "Torrelles de Llobregat"  # e.g. "L'Eixample" or None
...
INCLUDE_NATURAL_PARKS = False                         # Whether to include natural park data
# ================================
